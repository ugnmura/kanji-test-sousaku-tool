...
<svelte:head>
	<title>漢字テスト — 書き 答え</title>
</svelte:head>

<div class="p-4">
	<h2 class="text-lg font-semibold mb-3">漢字テスト（書き）— 答え</h2>
	<table class="w-full border-collapse">
		...
		<tbody>
			{#each vocabList as { front, back }}
				<tr>
					<td class="border border-gray-600 px-3 py-3 whitespace-nowrap w-0">{back}</td>
					<td class="border border-gray-600 px-3 py-3 w-full text-red-600">{front}</td>
				</tr>
			{/each}
		</tbody>
	</table>
